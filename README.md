...
For this assignment, you can find the `MachineLearningProject` folder containing the necessary project files on the [Machine Learning projects GitHub](https://github.com/ramjan-raeen/MachineLearningProject), under the `MachineLearningProject` folder. You may clone for optimization of accuracy!
